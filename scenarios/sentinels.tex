...
\addscenariosection{1}{Cooperative scenario}{Sentinels}{\spells/dispell.png}
...
\textbf{Starting Resources:} 10\svg{gold}, 2\svg{building_materials}, 1\svg{valuablegreater}

\textbf{Starting Income:} 10\svg{gold}, 2\svg{building_materials}, 1\svg{valuablegreater}
...
% \textbf{1$^{st}$ Round:}
% \begin{itemize}
%     \item Read the "Survival of the Fittest" section.
% \end{itemize}
